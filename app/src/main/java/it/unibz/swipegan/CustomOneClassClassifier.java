 ...
 */
public class CustomOneClassClassifier
     ...
     * Default constructor.
     */
    public CustomOneClassClassifier() {
        super();
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        m_AddOutlierFilter.setLabels(CustomOneClassClassifier.OUTLIER_LABEL);
    ...
    protected Instances mergeToTwo(Instances newData) throws Exception{
        ...
        for (int i = 0; i < theAttr.numValues(); i++) {
            if (! (theAttr.value(i).equalsIgnoreCase(CustomOneClassClassifier.OUTLIER_LABEL)
        ...
        if (mergeList.length() != 0) {
            ...
            m_MergeFilter.setLabel(CustomOneClassClassifier.OUTLIER_LABEL);
        ...
        for (int j = 0; j < numInstances; j++) {
            ...
            for (int i = 0; i < targetData.numAttributes(); i++) {
                if (targetData.classIndex() != i) {
                    ...
                    anInst.setValue(i, CustomOneClassClassifier.OUTLIER_LABEL);
                    if (m_UseInstanceWeights)
    ...
    public double[] distributionForInstance(Instance instance) throws Exception {
        ...
        if (instance.classAttribute().indexOfValue(CustomOneClassClassifier.OUTLIER_LABEL) == -1) {
            ...
            dist[instance.classAttribute().indexOfValue(CustomOneClassClassifier.OUTLIER_LABEL)] = probForOutlierClass;
    ...
    public static void main(String[] args) {
        runClassifier(new CustomOneClassClassifier(), args);
    }
}
